...
export const risSearchAnnouncements = tool('ris_search_announcements', {
  ...
  input: z.object({
    ...
    issuer: z
      ...
      .optional()
      .describe(
        'Issuing body — social_insurance (Urheber, e.g. ÖGK/SVS/BVAEB/AUVA/PVA), ministerial_decrees (Bundesministerium — abbreviation expanded server-side), council_minutes (Einbringer ministry). Values: ris_list_reference topic issuing_bodies or ministries.',
      ),
    norm: z
      .string()
      .optional()
